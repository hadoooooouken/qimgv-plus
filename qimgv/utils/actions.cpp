...
const QMap<QString, QVersionNumber> &Actions::getMap() { return mActions; }

QList<QString> Actions::getList() { return mActions.keys(); }
...
void Actions::init() {
  ...
  mActions.insert("cycleScalingFilter", QVersionNumber(0, 8, 3));
