...
void MW::setupUi() {
    ...
    connect(folderView.get(), &FolderViewProxy::nameFilterSelected, this, &MW::nameFilterSelected);
...
void MW::showCropPanel() {
    ...
    if(activeSidePanel != SIDEPANEL_CROP) {
        ...
        viewerWidget->setExpandSmallImagesInFitMode(true);
        viewerWidget->fitWindow();
...
void MW::hideCropPanel() {
    ...
    if(activeSidePanel == SIDEPANEL_CROP) {
        cropOverlay->hide();
        viewerWidget->setExpandSmallImagesInFitMode(false);
